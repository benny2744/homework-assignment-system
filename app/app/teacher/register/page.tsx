    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Register to start managing homework assignments</p>
        </div>
        ...
        <Card className="shadow-lg">
          <CardHeader>
            ...
            <CardDescription>
              Create a new account to access the homework management system
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600">
                ...
                <Link href="/teacher/login" className="text-blue-600 hover:text-blue-500 font-medium">
                  Sign In
                </Link>
              </p>
            </div>
